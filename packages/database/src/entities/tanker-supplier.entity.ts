...
@Entity({ name: "tanker_suppliers" })
export class TankerSupplierEntity {
  @PrimaryGeneratedColumn()
  id!: number;
  ...
  @Column({ name: "availability_start_time", type: "varchar", length: 5, default: "06:00" })
  availabilityStartTime!: string;

  @Column({ name: "availability_end_time", type: "varchar", length: 5, default: "22:00" })
